...
export default function SoliderForm() {
    ...
    return (
        <form onSubmit={handleSubmit}>
            <input className={styles.input} value={newSolider.First_Name} placeholder="שם פרטי" name="First_Name" required onChange={(e) => handleValidat('First_Name', e.target.value, /^(?=[a-zA-Zא-ת0-9._]{3,8}$)(?!.*[_.]{2})[^_.].*[^_.]$/, 'שם פרטי אינו תקין')} />
